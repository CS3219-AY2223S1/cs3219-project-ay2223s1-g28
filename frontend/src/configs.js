...
const URI_QUES_SVC = process.env.URI_QUES_SVC || 'http://localhost:8004';

const PREFIX_USER_SVC = '/api/user';
const PREFIX_COMM_SVC = '/api/chat';
const PREFIX_QUES_SVC = '/api/question';
...
export const URL_QUES_SVC = URI_QUES_SVC + PREFIX_QUES_SVC;
